...
if( !$User->type['User'] )
{
	...
	<?php
		...
		$welcomtext.='<p><b>What is BitDip?</b><br />BitDip is a game of grand strategy combined with a system of finance denominated in Bitcoin. Essentially, at BitDip you play for real money.</p>';
