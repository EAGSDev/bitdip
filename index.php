...
if( !$User->type['User'] )
{
	...
	<?php
		...
		$welcomtext.='<p><b>What is Bitcoin?</b><br /><a href="https://en.wikipedia.org/wiki/Bitcoin">Bitcoin</a> is a digital currency/money.</p>';
		$welcomtext.='<p><b>What is Diplomacy?</b><br /><a href="https://en.wikipedia.org/wiki/Diplomacy_%28game%29">Diplomacy</a> is a simple yet sophisticated game of grand strategy.</p>';
		$welcomtext.='<p><b>What is Bitcoin Diplomacy?</b><br />Bitcoin Diplomacy is an online version of the game Diplomacy (forked from <a href="http://webdiplomacy.net">webDiplomacy.net</a>) combined with a system of finance denominated in Bitcoin. Essentially, at BitDip you play Diplomacy for real money.</p>';
		$welcomtext.='<p><b>How is BitDip different from classic Diplomacy?</b><br />The goal in Bitcoin Diplomacy is not to "win" a game, but rather to increase wealth by controlling more supply centers and buying/selling supply centers profitably. A player enters a game by purchasing supply centers and exits a game by selling supply centers. The only way a game ends is if all the players agree to liquidate their supply centers, which is to cash-in the supply centers at par value, which was set when the game was created. Otherwise, the only way out of a game is to either be eliminated or sell out to another player.';
